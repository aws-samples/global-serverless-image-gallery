...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://gkay6dgev4.execute-api.us-east-1.amazonaws.com/prod';
    ...
    apigClient.uploadimagePost = function (params, body, additionalParams) {
        ...
        var uploadimagePostRequest = {
            ...
            path: pathComponent + uritemplate('/uploadimage').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
